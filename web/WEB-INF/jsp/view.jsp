<%@ page import="com.eurochemix.webapp.web.HtmlUtil" %>
<%@ page import="com.eurochemix.webapp.model.*" %>
...
<head>
    ...
    <jsp:useBean id="resume" type="com.eurochemix.webapp.model.Resume" scope="request"/>
...
<section>
    ...
    <p>
        <c:forEach var="type" items="${resume.contacts.keySet()}">
            <jsp:useBean id="type" type="com.eurochemix.webapp.model.ContactType"/>
